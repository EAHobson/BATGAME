...
plot(g2, 
     ...
     edge.color=alpha("black", 0.4),
     main= "Bat trajectories: thresholded social foraging (rare observations removed)", 
     #sub=paste0("Network density = ", round(edge_density(g),2)),
     vertex.size=17,
...
#this is backup data in case student data won't run (just delete the "#" from the start of the line below)
bet_hedge.locs <- read_csv("example_bethedge.csv") 
...
```{r socforg, echo=FALSE, fig.cap="For more information, visit http://hobsonresearch.com/index.php/sociality-game/", out.width = '100%'}
